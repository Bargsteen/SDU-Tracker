...
func getContainer() -> Container {
    let container: Container = {
        ...
        container.register(AlertHandlerProtocol.self) { r in AlertHandler(dateTimeHandler: r.resolve(DateTimeHandlerProtocol.self)!)}
        ...
        container.register(ChooseUserWindowProtocol.self) { r in ChooseUserWindow(settings: r.resolve(SettingsProtocol.self)!)}
        ...
        container.register(SettingsProtocol.self) { r in Settings(dateTimeHandler: r.resolve(DateTimeHandlerProtocol.self)!)}
